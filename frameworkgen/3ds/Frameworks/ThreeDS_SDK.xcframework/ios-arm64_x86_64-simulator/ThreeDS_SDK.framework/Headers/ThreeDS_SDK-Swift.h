...
/// Setter fot the text font
/// \param font the font given as an UIFont
///
- (void)setTextFontWithFont:(UIFont * _Nonnull)font;
...
///
/// returns:
/// The font used for the specific UI component
- (UIFont * _Nullable)getTextFont SWIFT_WARN_UNUSED_RESULT;
- (id _Nonnull)copyWithZone:(struct _NSZone * _Nullable)zone SWIFT_WARN_UNUSED_RESULT;
@end
...
/// Sets the font of the heading label text.
/// \param fontSize Font for the heading label text.
///
- (void)setHeadingTextFontWithFont:(UIFont * _Nonnull)font;
...
/// Returns the font of the heading label text.
///
/// returns:
/// The heading text font as UIFont.
- (UIFont * _Nullable)getHeadingTextFont SWIFT_WARN_UNUSED_RESULT;
- (id _Nonnull)copyWithZone:(struct _NSZone * _Nullable)zone SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_EXTERN void callbackDebugger(void) SWIFT_NOEXCEPT;


SWIFT_EXTERN void callbackIntegrity(void) SWIFT_NOEXCEPT;


SWIFT_EXTERN void callbackJailbreak(void) SWIFT_NOEXCEPT;


SWIFT_EXTERN NSArray<NCAWarning *> * _Nonnull detectedWarnings(void) SWIFT_NOEXCEPT SWIFT_WARN_UNUSED_RESULT;
