...
open class BaseRNInputField: UIView {
    ...
    /// Sets this field's `FieldStyles` (root/container/input/placeholder/label/error/accessory).
    public func setStyles(_ styles: FieldStyles) {
        configuration.styles = styles
    }

    /// Sets this field's `FieldOptions` (label, labelBehavior, errorDisplay, unstyled,
    /// accessibilityLabel/Hint, cardBrandIcon, cvcIcon).
    public func setOptions(_ options: FieldOptions) {
